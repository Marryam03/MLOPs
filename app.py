...
def predict(): 
    ...
    try:
        ...
        label_mapping = {
            0: 'Adware', 1: 'Backdoor', 2: 'Banker', 3: 'Benign', 4: 'Dropper', 
            5: 'FileInfector', 6: 'NoCategory', 7: 'PUA', 8: 'Ransomware', 
            9: 'Riskware', 10: 'SMS', 11: 'Scareware', 12: 'Spy', 13: 'Trojan', 14: 'Zeroday'
        }
        labeled_output = [label_mapping.get(label, 'Unknown') for label in numeric_output]
